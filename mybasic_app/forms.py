...
class EvaluteurSignUpForm(UserCreationForm):
    ...
    class Meta(UserCreationForm.Meta):
        ...
        fields=('first_name','last_name','username','password1','password2',
            'email','verify_email','numbr_Identd','Code_Eval','Organization','Country','site_Personnel',
...
class ChercheurSignUpForm(UserCreationForm):
    ...
    class Meta(UserCreationForm.Meta):
        model = User
        fields=('first_name','last_name','username','password1','password2',
            'email','verify_email','numbr_Identd','site_Personnel','Organization','Country','Phone',
...
class ArticleForm(forms.ModelForm):
    ...
    class Meta:
        model = Article
        fields = ['name' , 'description','Mots_Cleé','document','author_list']
        widgets = {
...
class ChoosingForm(forms.ModelForm ):
    ...
    def __init__(self, conf, *args, **kwargs):
        ...
        self.fields["art1"].queryset = Article.objects.filter(Conferance = conf)
        self.fields["art2"].queryset = Article.objects.filter(Conferance = conf)
        self.fields["art3"].queryset = Article.objects.filter(Conferance = conf)
